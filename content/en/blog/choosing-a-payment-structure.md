...
There are only **payment structures**, each with:
...
Example:
For Pix-style or domestic transfers, a **Paraguayan RUC** is typically required.
...
Every setup must be evaluated across:
